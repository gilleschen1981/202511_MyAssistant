...
// in myassistant/test/data/services/task_refresh_service_test.dart.
...
import 'package:myassistant/data/services/task_generation_service.dart' as _i8;
...
class MockTaskGenerationService extends _i1.Mock
    implements _i8.TaskGenerationService {
  MockTaskGenerationService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<_i2.TaskModel?> generateNextTask(_i3.PlanModel? plan) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i2.TaskModel>> generateAllPendingTasks(String? userId) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i2.TaskModel>> generateTasksForDateRange(
    String? userId,
    DateTime? startDate,
    DateTime? endDate,
  ) =>
